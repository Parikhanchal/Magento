 ...
 */
class CustomRadio implements DataPatchInterface, PatchRevertableInterface
{
   /**
    ...
    */
    ...
    public function addPhoneAttribute()
    {
        ...
        $eavSetup->addAttribute(
            ...
            'customer_custom_radio2',
            [
                'type' => 'int',
                'label' => 'Custom Customer Radio',
                'input' => 'select',
                'required' => 0,
                'visible' => 1,
                'user_defined' => 1,
        ...
        $attribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'customer_custom_radio2');
