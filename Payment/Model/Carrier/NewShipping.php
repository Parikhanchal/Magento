...
namespace Kitchen\Payment\Model\Carrier;
...
class NewShipping extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        $logger->info('new ship collectRates');
        $logger->info($this->getConfigFlag('active'));
        ...
        //condition for custome shipping 
        $total = $this->getConfigData('customePrice');
