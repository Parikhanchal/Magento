define([
    ...
    return Component.extend({
        ...
        // edit----------------------------------------------------------------
        getResidentialAddress: ko.observable(window.checkoutConfig.custom_residential),
        liftgateAddress: ko.observable(window.checkoutConfig.custom_liftgate),
        deliveryAddress: ko.observable(window.checkoutConfig.custom_delivery),
    ...
    // edit....start--------------------------------------------------
            this.getResidentialAddress.subscribe(function(value) {
                // self.residentialShip(value);
                self.residentialShip(value)
            });

            this.liftgateAddress.subscribe(function(value) {
                self.liftgateShip(value);
            });
            
            this.deliveryAddress.subscribe(function(value) {
       ...
       residentialShip: function(selectedValue)
        {
            ...
            if (selectElement.checked) {
                    document.getElementById("liftgate_ship").checked = true;
                    document.getElementById("delivery_appointment").checked = true;
                }
        
            storage.post(
                'ship/checkbox/residential',
                JSON.stringify({
        ...
        liftgateShip: function(selectedValue)
        {
            var selectElement = document.getElementById('liftgate_ship');
            // var selectedValue = selectElement.value;
            var selectedValue = selectElement.checked ? selectElement.value : 0;
        ...
        deliveryShip: function(selectedValue)
        {
            var selectElement = document.getElementById('delivery_appointment');
            // var selectedValue = selectElement.value;
            var selectedValue = selectElement.checked ? selectElement.value : 0;
