...
if(isset($_GET['edit_id'])) {
    $productDetail = getProductDetail($_GET['edit_id']);
}
?>
...
<body>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        <label for="p_id">Product ID:</label>
        <input type="text" name="p_id" required value="<?php echo isset($productDetail['p_id']) ? $productDetail['p_id'] : ''; ?>">
        <br/><br/>
        <label for="name">Name:</label>
        <input type="text" name="name" placeholder="Enter product name" required value="<?php echo isset($productDetail['name']) ? $productDetail['name'] : ''; ?>">
        <br/><br/>
        <label for="price">Price:</label>
        <input type="text" name="price" placeholder="Enter product price" required value="<?php echo isset($productDetail['price']) ? $productDetail['price'] : ''; ?>">
        <br/><br/>
        <label for="c_id">Category:</label>
        <select name="c_id">
            <?php 
...
class data extends Test
{
    ...
    function update_product()
    {
        ...
        $price = $_POST['price'];
        $c_id = $_POST['c_id'];
        $p_id = $_POST['p_id']; // Fetch product ID from POST request
