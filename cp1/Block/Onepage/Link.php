 ...
 */
namespace Cp\User\Block\Onepage;
...
public function isCustomerAllowedToPlaceOrder()
{
    ...
    $customerAllow = $customer->getCustomAttribute('customer_allow');

    if ($customerAllow && $customerAllow->getValue() !== null) {
       
        return $customerAllow->getValue() == 1;
    }
